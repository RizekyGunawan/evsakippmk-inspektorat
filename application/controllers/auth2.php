...
class Auth2 extends CI_Controller
{
	...
	{
		// Fetch one user with evaluator roles (3, 4, or 7)
		// In a real system, you might want a more specific evaluator.
		$evaluators = $this->m_auth2->get_evaluators();
		echo json_encode(!empty($evaluators) ? $evaluators[0] : null);
	}
