    ...
    public function getData()
    {
        ...
        $query = $this->db->query("
            SELECT 
                ...
                (CASE
                    WHEN (AVG(c.bobot2 * NULLIF(e.jawaban1, '')) / c.bobot2) = 100 THEN 'AA'
                    WHEN (AVG(c.bobot2 * NULLIF(e.jawaban1, '')) / c.bobot2) >= 90 THEN 'A'
                    WHEN (AVG(c.bobot2 * NULLIF(e.jawaban1, '')) / c.bobot2) >= 80 THEN 'BB'
                    WHEN (AVG(c.bobot2 * NULLIF(e.jawaban1, '')) / c.bobot2) >= 70 THEN 'B'
                    WHEN (AVG(c.bobot2 * NULLIF(e.jawaban1, '')) / c.bobot2) >= 60 THEN 'CC'
                    WHEN (AVG(c.bobot2 * NULLIF(e.jawaban1, '')) / c.bobot2) >= 50 THEN 'C'
