                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <th class="text-center align-middle" style="width: 200px">Kriteria yang dinilai 1</th>
                      ...
                      <th class="text-center align-middle" style="width: 20px" >Aksi</th>
                            ...
                            <tbody>
                              ...
                              <tr data-widget="expandable-table " aria-expanded="false">
                                ...
                                if ($krit['jawaban1'] == "0"){echo "XX1";} elseif ($krit['jawaban1'] == "0.5"){echo "Sebagian";} elseif ($krit['jawaban1'] == "1"){echo "YY1";} elseif ($krit['jawaban1'] == "0.33"){echo "Sebagian Kecil";} elseif ($krit['jawaban1'] == "0.66"){echo "Sebagian Besar";} else {echo "Y/T";}; ?> </td>
      ...
      <div class="modal-body">
        ...
        <form id="formkrit">
          ...
          <div class="form-group col-md-6">
            <label>Kriteria yang Dinilai 4</label>
    ...
    <div class="modal-content">
      ...
      <div class="form-group col-md-6">
          ...
          <div class="row"> 
            ...
            <select name="jawaban0" id="jawaban0" class="form-control">
