...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?php echo base_url() ?>assets/dist/img/s.png" target="_blank" class="brand-link">
    <img src="<?php echo base_url() ?>assets/dist/img/s.png" alt="AdminLTE Logo"
...
<script>
  ...
  navLinks.forEach(navLink => {
    navLink.addEventListener("click", function (event) {
      ...
      // Mengabaikan aksi ini untuk elemen treeview (dropdown) agar fitur AdminLTE bisa berjalan
      if (href === "#") {
        return;
      }
