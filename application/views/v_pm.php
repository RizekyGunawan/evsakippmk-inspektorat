                   ...
                   <div <?php if($this->session->userdata('id_unit') == ""){echo "hidden";}else{echo "";}; ?> class="col-">
                    ...
                    <?php foreach ($loadtu as $load): ?>
                        <button type="button" class="btn btn-primary" <?php if ($load['id_pm'] == "") { echo ""; } elseif ($load['id_pm'] != "") { echo "disabled"; } else { echo "disabled"; }; ?>
                            data-toggle="modal" data-target="<?php if ($load['id_pm'] == "") { echo "#InsertData"; } elseif ($load['id_pm'] != "") { echo "#"; } else { echo "#"; }; ?>">
                            Load Data
                        </button>
                    <?php endforeach; ?>
                <?php endif; ?>
                ...
                <table class="table table-hover">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th class="text-center align-middle" style="width: 100px" colspan="2" >Nilai Akuntabilitas Kinerja</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <th class="text-center align-middle" style="width: 200px" colspan="2" >Bukti (Link/File)</th>
                  ...
                  <tbody>
                    ...
                    <?php foreach ($sub as $subk): ?>
                     ...
                     <tr data-widget="expandable-table" elementId="s<?php echo $subk['id_subkomponen']; ?>" aria-expanded="false">
                      ...
                      <td  title="<?php echo $subk['dok_pendukung']; ?>" class="text-truncate align-middle" style="max-width: 150px;" style="width: 150px">
                                  <i class="expandable-table-caret "></i>
                         ...
                         <?php if (($this->session->userdata('id_role') == 4 || (($this->session->userdata('id_role') == 1 || $this->session->userdata('id_role') == 5) && ($this->session->userdata('id_unit') == $this->session->userdata('id_unit2') || 
                              ...
                              <div 
                               <?php if ($subk['pm_modified_by'] != ""): ?>
                                 ...
                                 <?php endif; ?>  
                              class="btn btn-info btn-xs open-modal0" data-id_pm0="<?php echo $subk['id_pm0']; ?>">
                    ...
                    <tr>
                      ...
                      <th class="text-center align-middle" style="width: 300px">Kriteria yang dinilai 2</th>
                      ...
                      <th class="text-center align-middle" style="width: 20px" >Aksi</th>
                            ...
                            <tbody>
                              ...
                              <td title="<?php echo $krit['dok_pendukung2']; ?>" class="text-truncate align-middle" style="max-width: 150px; width: 150px;">
                                      <i class="expandable-table-caret"></i>
                                      <div class="text-truncate">
                                        <?php
                                        $url = $krit['link_bukti'];
                              ...
                              <td class="text-center align-middle" style="width: 30px">
                               ...
                               $this->session->userdata('id_unit') == $this->session->userdata('id_unit_es1')))) && $krit['status_data'] == "0"): ?>
                                 ...
                                 <?php endif; ?> 
                                    class="btn btn-success btn-xs open-modal" data-id_pm="<?php echo $krit['id_pm']; ?>">
                                        <i class="fas fa-edit"></i>
                                    </div>
                                <?php endif; ?>
                                 ...
                                 title="last modified by: <?php echo $krit['pm_modified_by']; ?>"
                                 <?php endif; ?> 
                                    class="btn btn-primary btn-xs open-modal" data-id_pm="<?php echo $krit['id_pm']; ?>">
                                        <i class="fas fa-search"></i>
                                    </div>
                                <?php endif; ?>
                            </td>
        ...
        <input type="hidden" id="id_pm" name="id_pm">
          ...
          <div class="row">
            <div class="form-group col-md-6">
              <label>Kriteria yang Dinilai 3</label>
...
<div class="modal fade" id="UploadDataSub" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              ...
              <th style="width: 30px">Hapus</th> </tr>
          </thead>
